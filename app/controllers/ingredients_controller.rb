class IngredientsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @ingredient.save
        format.html { redirect_to @ingredient, notice: 'Ingridient was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @ingredient.update_attributes(params[:ingredient])
        format.html { redirect_to @ingredient, notice: 'Ingridient was successfully updated.' }
